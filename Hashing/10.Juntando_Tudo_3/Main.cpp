...
int main() {
    ...
    while (cin >> opcao && opcao != 5) {
        ...
        switch (opcao) {
            ...
            case 1: // inserir
                cin >> chave;
                hash_insert(t, m, chave); // inserido parâmetros de inserção quadrática
                break;
            ...
            case 2: // pesquisar
                ...
                cout << hash_search(t, m, chave) << endl; // inserido parâmetros de busca quadrática
                break;

            case 3: // remover
                cin >> chave;
                hash_remove(t, m, chave); // inserido parâmetros de remoção quadrática
                break;
