...
int hash_insert(dado t[], int m, int k, string info); // alterada para receber string

// Função para pesquisa usando sondagem linear
int hash_search(dado t[], int m, int k, string info); // alterada para receber string

// Função para remoção de elementos em tabelas hash
int hash_remove(dado t[], int m, int k, string info); // alterada para receber string
